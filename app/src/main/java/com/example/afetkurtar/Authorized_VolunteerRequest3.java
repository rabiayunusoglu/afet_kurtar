...
public class Authorized_VolunteerRequest3 extends AppCompatActivity {
    ...
    RequestQueue queuev, queue, queuecheck, queue1;
    static EditText afet, sbp;
    Spinner subpartSpinner;
    int index = 0;
    static double latitude, logtitude;
    static int dataSupartID = 0, dataSupartresponse = 0, dataSupartrequest = 0, dataSupartteamID = 0;
    static boolean dataSupartEXP = false;
    static boolean dataSupartAid = false;
    static String responceStringSubpart = "", dataSupartName = "", dataSupartAddress = "", dataSupartrole = "";
...
//Get current date time
                        ...
                        obj.put("volunteerName", dataSupartName);
                        ...
                        obj.put("role", dataSupartrole);
                        obj.put("assignedTeamID", dataSupartteamID);
                    } catch (Exception e) {
                    ...
                    queue1.add(request);
                    Toast.makeText(getApplicationContext(), "İstek başarıyla kabul edildi.", Toast.LENGTH_SHORT).show();
        ...
        JsonObjectRequest request = new JsonObjectRequest(
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        while (responceStringSubpart.indexOf("}") > 1) {
                            if (responceStringSubpart.contains("{")) {
                                ...
                                String valueadr = "\"haveFirstAidCert\":\"";
                                String valuerole = "\"haveFirstAidCert\":\"";
                                String valuelat = "\"haveFirstAidCert\":\"";
                                String valueTeamID = "\"haveFirstAidCert\":\"";
                                String valuelong = "\"haveFirstAidCert\":\"";

                                String flag = "\"";
                                String result = "", resultadr = "", resultRol = "";
                        ...
                        subpartSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                if (dataSupartName.equals("Seçilmedi")) {
                                    ...
                                    dataSupartAid = arrayListSubpartAid.get(index);
                                    dataSupartEXP = arrayListSubpartEXP.get(index);
                                    dataSupartrole = arrayListSubpartRole.get(index);
                                    dataSupartAddress = arrayListSubpartAdres.get(index);
                                    latitude = arrayListSubpartlatitude.get(index);
                                    logtitude = arrayListSubpartlongtitude.get(index);
                                    dataSupartteamID = arrayListSubpartTEAMID.get(index);
                ...
                new Response.ErrorListener() { // the error listener
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(getApplicationContext(), Authorized_VolunteerRequest.afetBolgesi + "nin " + Authorized_VolunteerRequest2.dataSupartName + "ini tercih eden bir gönüllü yoktur!", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
        queue.add(request);
